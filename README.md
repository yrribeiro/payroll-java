...
| -------- | -------------------------------| :---:|:---:|:---:|
|     1    |  Negative conditional              | CreatePayment; FindEmployee| :heavy_check_mark:; :x: |[#12](https://github.com/yrribeiro/payroll-java/issues/12); [#13](https://github.com/yrribeiro/payroll-java/issues/13)|
